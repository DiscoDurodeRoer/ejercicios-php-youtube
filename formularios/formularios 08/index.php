...
<body>
    ...
    if (isset($_POST['insertar'])) {
        ...
        if (count($_SESSION['alumnos']) === 0) {
            echo "No hay alumnos que volcar";
        } else {
            ...
            if (!isset($_POST['dnis'])) {
                ...
                foreach ($_SESSION['alumnos'] as $key => $value) {
                    ...
                    if (in_array($key, $dnis)) {
                        ...
                        $consulta = "SELECT * FROM alumnos WHERE dni = '" .$key . "'";
                        ...
                        if($filas === 1){
                            $sql .= "UPDATE alumnos ";
                            $sql .= "SET nombre = '". $value['nombre'] . "', ";
                            $sql .= "apellido1 = '". $value['apellido1'] . "', ";
                            $sql .= "apellido2 = '". $value['apellido2'] . "' ";
                            $sql .= "WHERE dni = '". $key . "'";
                        }else{
                            $sql .= "INSERT INTO alumnos ";
                            $sql .= "VALUES ('".$key."', '". $value['nombre'] . "', ";
                            $sql .= "'". $value['apellido1'] . "','". $value['apellido2'] . "'); ";
                        }
